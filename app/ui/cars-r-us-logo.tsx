...
export default function CarsRUsLogo({ displayIcon, hideIfMobile = false }: CarsRUsLogoProps) {
  return (
    <div className={`${merinda.className} flex items-center space-x-3 text-nowrap text-white`}>
      {displayIcon && (
